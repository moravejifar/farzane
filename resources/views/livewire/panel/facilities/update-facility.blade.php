            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" onsubmit="return  false">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select value="1" name="facilitytype_name" class="form-control" wire:model="data.facilitytype_id" >
                            <option value="{{$data['facilitytype_id']}}">{{$facilitytype_name}}</option>
                            @foreach($type as $row)
                    ...
                    @error('data.facilitytype_name')
                        <small class="d-block text-danger w-100 text-center">{{ $message }} </small>
                    @enderror

                    <div class="form-group col-lg-12">
                        <label class="col-lg-8" for="facility_name"> نام تسهیلات</label>
                        <input class=" form-control" id="facility_name" name="facility_name" type="text" size="3px" value="نام تسهیلات"
