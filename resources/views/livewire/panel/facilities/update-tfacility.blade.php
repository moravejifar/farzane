        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" onsubmit="return false">
                {{-- <div class="form-group col-lg-12">
                    <label class="col-lg-8" for="facilitytype_id"> شناسه تسهیلات</label>
                    <input class=" form-control" id="facilitytype_id" name="facilitytype_id" type="text" size="3px" value="شناسه تسهیلات"
