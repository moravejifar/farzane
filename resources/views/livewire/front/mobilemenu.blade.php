        ...
        <div class="row">
                    ...
                    <div class="booking-form">
                        ...
                        <form action="#">
                            <div class="b-date arrive mb-15">
                                <input data-jdp type="text" placeholder="تاریخ ورود">
                                <i class="mdi mdi-calendar-text" style="top: 5px"></i>
                            </div>

                            <div class="b-date departure mb-15">
                                <input data-jdp type="text" placeholder="تاریخ عزیمت">
                                <i class="mdi mdi-calendar-text" style="top: 5px"></i>
                            </div>
            ...
            <div class="col-md-8 col-sm-7">
                <div class="welcome-text">
                    ...
                    <p class="welcome-desc" style="direction:rtl text-align: right
                             ">There
